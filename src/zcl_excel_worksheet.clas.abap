...
*"* do not include other source files here!!!
  ...
  methods MOVE_CELL
    importing
      !IP_COLUMN_SRC type SIMPLE
      !IP_ROW_SRC type ZEXCEL_CELL_ROW
      !IP_COLUMN_DST type SIMPLE
      !IP_ROW_DST type ZEXCEL_CELL_ROW
    raising
      ZCX_EXCEL .
  PROTECTED SECTION.
private section.
...
METHOD move_cell.
  DATA: lp_value TYPE zexcel_cell_value,
        lp_style TYPE REF TO zcl_excel_style,
